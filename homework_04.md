...
#### 7. **Общая шина данных (Event Bus)**
  - Асинхронное взаимодействие между сервисами.

<img src="res/container_diag.png" width="1000">
...
#### 4. Сервис уведомлений:
  - **Message Queue (Kaffka):** Обработка и доставка уведомлений.
#### 5. Сервис аналитики:
  - **Хранилище данных (Redshift):** Исторические данные для анализа.
...
<img src="res/deploy_diag.png" width="1000">
