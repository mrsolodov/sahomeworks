...
## Критичный сценарий: Бронирование номера
...
<img src="res/sequence_diag.png" width="1000">
...
1. **Надежность**
    ...
    - **Показатели:** Уровень доступности системы — 99%. 
...
5. **Безопасность**
    ...
    - **Показатели:** Все платежи должны быть зашифрованы. Личные данные пользователей должны храниться в зашифрованном виде.
